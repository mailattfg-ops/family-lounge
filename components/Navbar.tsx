...
export default function Navbar() {
  ...
  return (
    <nav className="sticky h-0 top-0 z-50 bg-[#f6f6f6]">
      ...
      <div className="max-w-[1250px] mx-auto flex justify-center pt-2 items-center">
        ...
        <div className="w-fit grid gap-2 flex justify-center">
          ...
          <ul className="w-fit space-y-2 flex justify-center gap-2 md:gap-4 bg-[#3e3e3e] text-[#686868] rounded-lg items-center text-[9px] md:text-[19.12px] lg:text-[19.12px] CalSans-re-font px-2 py-2 md:px-4 md:py-3">
            <li className="m-0">
