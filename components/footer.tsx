                ...
                <div className="w-full lg:w-2/3 flex flex-col sm:flex-row items-center sm:items-start justify-center lg:justify-end gap-12 md:gap-12 lg:gap-16 Inter-re-font text-center sm:text-left">
                    ...
                    <div className="flex flex-col items-center sm:items-start max-w-[300px]">
                        ...
                        <ul className="space-y-1 text-[#4a4a4a] text-sm mb-6">
                            <li><Link href="tel:+919495388624" className="hover:text-black transition-colors">+91 949 5388 624</Link></li>
                            <li><Link href="tel:+916282057622" className="hover:text-black transition-colors">+91 628 2057 622</Link></li>
                        </ul>
                        
                        <div className="flex gap-4">
                            <Link href={'https://wa.me/919495388624'} target="_blank" className="p-2.5 bg-gray-200 rounded-full hover:bg-[#25D366] hover:text-white transition-all duration-300" title="Chat on WhatsApp">
