    ...
    <>
      <div className="w-full grid place-items-center text-center gap-10 pt-15 md:pt-10">
        ...
        <div className="w-full grid md:flex items-center justify-center gap-9 md:gap-15 px-4 md:px-0">
          <div className="w-full md:w-[194.90823364257812px] grid justify-center reveal opacity-0 translate-y-20 transition-all duration-1000 delay-100 ease-[cubic-bezier(0.16,1,0.3,1)]">
          ...
          <div className="w-full md:w-[194.90823364257812px] grid justify-center reveal opacity-0 translate-y-20 transition-all duration-1000 delay-200 ease-[cubic-bezier(0.16,1,0.3,1)]">
            <div className="w-full flex justify-center">
              <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="theme-text w-[45.70712661743164px] h-[50.90461349487305px] ">
          ...
          <div className="h-[2px] md:h-auto md:self-stretch w-full md:w-[2px] theme-bg"></div>
          <div className="w-full md:w-[194.90823364257812px] grid justify-center reveal opacity-0 translate-y-20 transition-all duration-1000 delay-300 ease-[cubic-bezier(0.16,1,0.3,1)]">
            <div className="w-full flex justify-center">
              <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="theme-text w-[45.70712661743164px] h-[50.90461349487305px] ">
          ...
          <div className="h-[2px] md:h-auto md:self-stretch w-full md:w-[2px] theme-bg"></div>
          <div className="w-full md:w-[300px] grid justify-center reveal opacity-0 translate-y-20 transition-all duration-1000 delay-400 ease-[cubic-bezier(0.16,1,0.3,1)]">
            <div className="w-full flex justify-center">
              <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="theme-text w-[45.70712661743164px] h-[50.90461349487305px] ">
