  ...
  return (
    <>
      <div className="w-full grid place-items-center text-center gap-10 pt-15 md:pt-10">
        ...
        <div className="w-full grid md:flex items-center justify-center gap-9 md:gap-15">
          <div className="w-full md:w-[194.90823364257812px] grid justify-center">
            ...
            <p className="theme-text font-calsans font-400 text-[47.01px] leading-[100%] tracking-[0%] text-center">Safety First</p>
          </div>
          <div className="self-stretch w-[2px] theme-bg"></div>
          <div className="w-full md:w-[194.90823364257812px] grid justify-center">
            <div className="w-full flex justify-center">
              <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="theme-text w-[45.70712661743164px] h-[50.90461349487305px] ">
            ...
            <p className="theme-text font-calsans font-400 text-[47.01px] leading-[100%] tracking-[0%] text-center">Premium Selection</p>
          </div>
          <div className="self-stretch w-[2px] theme-bg"></div>
          <div className="w-full md:w-[194.90823364257812px] grid justify-center">
            <div className="w-full flex justify-center">
            ...
            <p className="theme-text font-calsans font-400 text-[47.01px] leading-[100%] tracking-[0%] text-center">24/7 Support</p>
          </div>
          <div className="self-stretch w-[2px] theme-bg"></div>
          <div className="w-full md:w-[300px] grid justify-center">
            ...
            <p className="theme-text font-calsans font-400 text-[47.01px] leading-[100%] tracking-[0%] text-center">Unforgettable Experiences</p>
          </div>
          {/* <div className="self-stretch w-[2px] theme-bg"></div> */}
        </div>
      ...
      <div className="w-full grid place-items-center text-center pt-20 md:pt-10 gap-6 md:gap-10">
        <p className="w-[320px] text-black text-[28px] md:text-[32px] leading-[80%] flex items-center md:gap-3 font-500">
          <span className="w-[18px] h-[14px] md:h-[18px] rounded-full theme-bg inline-block"></span>
          What our students have to say
        </p>
        <div className="w-full grid md:flex items-center justify-center gap-10">
          <div className="w-[330px] md:w-[400px] h-[483px] bg-[#F7F8FC] border border-[#A7A7A7] rounded-[17px] pt-[55px] px-[30px] grid">
            <p className="Grotesk-font font-normal text-[20px] md:text-[28px] leading-[32px] text-center text-[#070708]">"Working with this team has truly pushed our company to improve. Their tailored solutions have made a significant difference in our operations!"</p>
            <div>
              <div>
                <Image
                  src="/Courses/user.jpg"
                  alt="testimonial"
                  priority
                  width={80}
                  height={80}
              ...
              <p className="font-shadgrotesk font-normal text-[20px] leading-[34px] text-center text-black">Jake Harrison</p>
